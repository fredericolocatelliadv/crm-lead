...
6. O sistema verifica se a conversa permite IA.
7. O sistema monta contexto seguro para o Gemini.
8. Gemini devolve resposta e classificação estruturadas.
9. O sistema valida a resposta.
10. A resposta automática é enviada pelo WhatsApp.
11. A mensagem da IA, sessão e classificação são salvas.
12. A equipe vê o atendimento no CRM.
13. Um humano pode assumir ou pausar a IA.
...
- `Nota interna`: registra observação sem enviar ao cliente.
